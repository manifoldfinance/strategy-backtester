    ...
    run() {
      ...
      for (let i = 0; i < length; i++) {
        console.log(
          ...
          //     'i :>> ', i,
          ".buyPnL[]",
          this.buyPnL[this.buyPnL.length - 1],
          ".sellPnL[]",
          this.sellPnL[this.sellPnL.length - 1],
          "provisional[pre last]:>> ",
          this.provisionalBalance[this.provisionalBalance.length - 2],
          "provisional[last]:>> ",
          this.provisionalBalance[this.provisionalBalance.length - 1]
...
class TradeManagement {
  ...
  updateBalance() {
    ...
    const balance =
      ...
      this.buyPnL[pnlLength - 1] +
      this.sellPnL[pnlLength - 1];
