...
class MyStrategy extends Strategy {
  ...
  next() {
    const isUpContinual =
      this.ttm[0] >= this.ttm[1] && this.ttm[4] >= this.ttm[3];
    const isDownContinual =
      this.ttm[0] <= this.ttm[1] && this.ttm[3] >= this.ttm[4];
    ...
    const isBuyFrequent =
      this.ttm[2] > this.ttm[3] && this.ttm[4] > this.ttm[3];
    const isSellFrequent =
      this.ttm[2] < this.ttm[3] && this.ttm[3] > this.ttm[4];
